...
if "data" not in st.session_state:
    df_data = pd.read_csv(r"C:\Users\RAYSON\4_Streamlit_Game_Dados_Fifa\datasets\CLEAN_FIFA23_official_data.csv",index_col=0)
    df_data = df_data[df_data['Contract Valid Until'] >= 2021]
